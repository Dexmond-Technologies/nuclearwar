...
exports.ProgressChartsPanel = void 0;
...
class ProgressChartsPanel extends Panel_1.Panel {
    constructor() {
    ...
    createTooltip() {
        ...
        Object.assign(this.tooltip.style, {
            ...
            display: 'none',
            whiteSpace: 'nowrap',
            boxShadow: `0 2px 6px ${(0, utils_1.getCSSColor)('--shadow-color')}`,
        });
     ...
     */
    renderD3Chart(container, data, color) {
     ...
     */
    addHoverInteraction(g, data, x, y, width, height, color, container) {
...
exports.ProgressChartsPanel = ProgressChartsPanel;
// ---- Formatting Helpers ----
