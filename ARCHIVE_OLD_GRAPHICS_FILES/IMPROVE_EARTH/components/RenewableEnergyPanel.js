...
exports.RenewableEnergyPanel = void 0;
const Panel_1 = require("./Panel");
const d3 = __importStar(require("d3"));
const utils_1 = require("@/utils");
const dom_utils_1 = require("@/utils/dom-utils");
class RenewableEnergyPanel extends Panel_1.Panel {
    constructor() {
     ...
     */
    renderGauge(container, percentage, year) {
        const size = 140;
        const radius = size / 2;
        ...
        g.append('text')
            ...
            .attr('dy', '-0.15em')
            .attr('fill', (0, utils_1.getCSSColor)('--text'))
            .attr('font-size', '22px')
        ...
        g.append('text')
            ...
            .attr('dominant-baseline', 'central')
            .attr('dy', '1.4em')
            .attr('fill', (0, utils_1.getCSSColor)('--text-dim'))
            .attr('font-size', '10px')
            .text('Renewable');
     ...
     */
    renderSparkline(container, historicalData) {
        ...
        const xExtent = d3.extent(historicalData, d => d.year);
        const yExtent = d3.extent(historicalData, d => d.value);
        const yPadding = (yExtent[1] - yExtent[0]) * 0.1;
        const x = d3.scaleLinear().domain(xExtent).range([0, width]);
        const y = d3.scaleLinear()
            .domain([yExtent[0] - yPadding, yExtent[1] + yPadding])
            .range([height, 0]);
        const greenColor = (0, utils_1.getCSSColor)('--green');
        // Area fill
        const area = d3.area()
            .x(d => x(d.year))
            .y0(height)
     ...
     */
    renderRegions(container, regions) {
        ...
        for (let i = 0; i < regions.length; i++) {
            ...
            Object.assign(bar.style, {
                ...
                height: '100%',
                background: (0, utils_1.getCSSColor)('--green'),
     ...
     */
    renderCapacityChart(container, series) {
        ...
        const g = svg.append('g')
            .attr('transform', `translate(${margin.left},${margin.top})`);
        // Colors
        const solarColor = (0, utils_1.getCSSColor)('--yellow');
        const windColor = (0, utils_1.getCSSColor)('--semantic-info');
        const coalColor = (0, utils_1.getCSSColor)('--red');
...
exports.RenewableEnergyPanel = RenewableEnergyPanel;
