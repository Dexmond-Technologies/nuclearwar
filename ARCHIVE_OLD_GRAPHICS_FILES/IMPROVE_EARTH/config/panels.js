...
exports.STORAGE_KEYS = exports.MONITOR_COLORS = exports.PANEL_CATEGORY_MAP = exports.LAYER_TO_SOURCE = exports.MOBILE_DEFAULT_MAP_LAYERS = exports.DEFAULT_MAP_LAYERS = exports.DEFAULT_PANELS = void 0;
...
const FINANCE_MOBILE_MAP_LAYERS = {
    conflicts: false,
    bases: false,
    cables: false,
    pipelines: false,
...
// ============================================
exports.DEFAULT_PANELS = variant_1.SITE_VARIANT === 'happy' ? HAPPY_PANELS : variant_1.SITE_VARIANT === 'tech' ? TECH_PANELS : variant_1.SITE_VARIANT === 'finance' ? FINANCE_PANELS : FULL_PANELS;
exports.DEFAULT_MAP_LAYERS = variant_1.SITE_VARIANT === 'happy' ? HAPPY_MAP_LAYERS : variant_1.SITE_VARIANT === 'tech' ? TECH_MAP_LAYERS : variant_1.SITE_VARIANT === 'finance' ? FINANCE_MAP_LAYERS : FULL_MAP_LAYERS;
exports.MOBILE_DEFAULT_MAP_LAYERS = variant_1.SITE_VARIANT === 'happy' ? HAPPY_MOBILE_MAP_LAYERS : variant_1.SITE_VARIANT === 'tech' ? TECH_MOBILE_MAP_LAYERS : variant_1.SITE_VARIANT === 'finance' ? FINANCE_MOBILE_MAP_LAYERS : FULL_MOBILE_MAP_LAYERS;
/** Maps map-layer toggle keys to their data-freshness source IDs (single source of truth). */
exports.LAYER_TO_SOURCE = {
