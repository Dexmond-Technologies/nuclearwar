...
exports.getPortsByType = getPortsByType;
exports.getTopContainerPorts = getTopContainerPorts;
exports.PORTS = [
    // Top Container Ports
...
function getPortsByType(type) {
    return exports.PORTS.filter(p => p.type === type);
}
function getTopContainerPorts(limit = 20) {
    return exports.PORTS.filter(p => p.rank != null).sort((a, b) => (a.rank ?? 999) - (b.rank ?? 999)).slice(0, limit);
}
