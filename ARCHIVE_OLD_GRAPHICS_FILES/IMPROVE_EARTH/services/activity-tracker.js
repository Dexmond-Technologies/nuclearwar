...
exports.activityTracker = exports.HIGHLIGHT_DURATION_MS = exports.NEW_TAG_DURATION_MS = void 0;
/** Duration to show "NEW" tag on items (2 minutes) */
exports.NEW_TAG_DURATION_MS = 2 * 60 * 1000;
/** Duration for highlight glow effect (30 seconds) */
exports.HIGHLIGHT_DURATION_MS = 30 * 1000;
class ActivityTracker {
    ...
    isNewItem(panelId, itemId) {
        ...
        if (!firstSeen)
            return false;
        return Date.now() - firstSeen < exports.NEW_TAG_DURATION_MS;
    }
    /**
    ...
    shouldHighlight(panelId, itemId) {
        ...
        if (!firstSeen)
            return false;
        return Date.now() - firstSeen < exports.HIGHLIGHT_DURATION_MS;
    }
    /**
