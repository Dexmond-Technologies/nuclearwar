...
exports.fetchCyberThreats = fetchCyberThreats;
const service_client_1 = require("@/generated/client/worldmonitor/cyber/v1/service_client");
const utils_1 = require("@/utils");
// ---- Client + Circuit Breaker ----
const client = new service_client_1.CyberServiceClient('', { fetch: (...args) => globalThis.fetch(...args) });
const breaker = (0, utils_1.createCircuitBreaker)({ name: 'Cyber Threats', cacheTtlMs: 10 * 60 * 1000, persistCache: true });
...
async function fetchCyberThreats(options = {}) {
