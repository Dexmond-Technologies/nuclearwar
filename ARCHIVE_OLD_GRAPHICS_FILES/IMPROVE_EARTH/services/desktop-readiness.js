...
exports.DESKTOP_PARITY_FEATURES = void 0;
exports.getNonParityFeatures = getNonParityFeatures;
exports.getDesktopReadinessChecks = getDesktopReadinessChecks;
exports.getKeyBackedAvailabilitySummary = getKeyBackedAvailabilitySummary;
const runtime_config_1 = require("./runtime-config");
const keyBackedFeatures = [
    'aiOllama',
    'aiGroq',
    'aiOpenRouter',
    'economicFred',
...
exports.DESKTOP_PARITY_FEATURES = [
    {
        id: 'live-news',
        panel: 'LiveNewsPanel',
...
function getNonParityFeatures() {
    return exports.DESKTOP_PARITY_FEATURES.filter(feature => feature.locality !== 'fully-local');
}
function getDesktopReadinessChecks(localBackendEnabled) {
    const liveTrackingReady = (0, runtime_config_1.isFeatureAvailable)('aisRelay') || (0, runtime_config_1.isFeatureAvailable)('openskyRelay');
    return [
        ...
        { id: 'summaries', label: 'Summaries (provider-backed or browser fallback)', ready: (0, runtime_config_1.isFeatureAvailable)('aiOllama') || (0, runtime_config_1.isFeatureAvailable)('aiGroq') || (0, runtime_config_1.isFeatureAvailable)('aiOpenRouter') },
...
function getKeyBackedAvailabilitySummary() {
    const available = keyBackedFeatures.filter(featureId => (0, runtime_config_1.isFeatureAvailable)(featureId)).length;
