...
exports.fetchGivingSummary = fetchGivingSummary;
exports.formatCurrency = formatCurrency;
exports.formatPercent = formatPercent;
exports.getActivityColor = getActivityColor;
exports.getTrendIcon = getTrendIcon;
exports.getTrendColor = getTrendColor;
const service_client_1 = require("@/generated/client/worldmonitor/giving/v1/service_client");
...
const client = new service_client_1.GivingServiceClient('', { fetch: (...args) => globalThis.fetch(...args) });
const emptyResult = {
...
async function fetchGivingSummary() {
    ...
    const hydrated = (0, bootstrap_1.getHydratedData)('giving');
    if (hydrated) {
