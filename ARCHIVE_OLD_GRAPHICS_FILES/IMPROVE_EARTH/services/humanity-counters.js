...
exports.COUNTER_METRICS = void 0;
exports.getCounterValue = getCounterValue;
exports.formatCounterValue = formatCounterValue;
const SECONDS_PER_YEAR = 31536000;
exports.COUNTER_METRICS = [
    {
        id: 'births',
        label: 'Babies Born Today',
        annualTotal: 135600000, // UN Population Division World Population Prospects 2024
        source: 'UN Population Division',
        perSecondRate: 135600000 / SECONDS_PER_YEAR, // ~4.3/sec
    ...
    },
    {
        ...
        annualTotal: 15300000000, // Global Forest Watch / FAO reforestation estimates
        source: 'Global Forest Watch / FAO',
        perSecondRate: 15300000000 / SECONDS_PER_YEAR, // ~485/sec
    ...
    },
    {
        ...
        annualTotal: 4600000000, // WHO / UNICEF WUENIC Global Immunization Coverage 2024
        source: 'WHO / UNICEF',
        perSecondRate: 4600000000 / SECONDS_PER_YEAR, // ~146/sec
    ...
    },
    {
        ...
        annualTotal: 70000000, // UNESCO Institute for Statistics tertiary + secondary completions
        source: 'UNESCO Institute for Statistics',
        perSecondRate: 70000000 / SECONDS_PER_YEAR, // ~2.2/sec
    ...
    },
    {
        ...
        annualTotal: 2200000, // UNESCO / Bowker ISBN agencies global estimate
        source: 'UNESCO / Bowker',
        perSecondRate: 2200000 / SECONDS_PER_YEAR, // ~0.07/sec
    ...
    },
    {
        ...
        annualTotal: 510000, // IRENA 2024 renewable capacity additions in MW
        source: 'IRENA / IEA',
        perSecondRate: 510000 / SECONDS_PER_YEAR, // ~0.016/sec
 ...
 */
function formatCounterValue(value, precision) {
