...
exports.fetchRenewableInstallations = fetchRenewableInstallations;
/**
 ...
 */
async function fetchRenewableInstallations() {
    const { default: data } = await Promise.resolve().then(() => __importStar(require('@/data/renewable-installations.json')));
    return data;
}
