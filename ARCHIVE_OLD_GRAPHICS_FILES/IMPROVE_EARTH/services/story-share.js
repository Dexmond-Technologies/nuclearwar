...
exports.shareTexts = void 0;
exports.generateStoryDeepLink = generateStoryDeepLink;
exports.parseStoryParams = parseStoryParams;
exports.generateQRCode = generateQRCode;
exports.getShareUrls = getShareUrls;
// Deep link generator for story sharing
function generateStoryDeepLink(countryCode, type = 'ciianalysis', score, level) {
...
exports.shareTexts = {
    twitter: (data) => `${countryFlag(data.countryCode)} ${data.countryName} Intelligence Brief\n\n` +
    ...
    whatsapp: (data) => `${countryFlag(data.countryCode)} *${data.countryName} Intelligence Brief*\n\n` +
        `*Instability:* ${data.cii?.score || 'N/A'}/100 (${data.cii?.level || 'N/A'})\n` +
    ...
    linkedin: (data) => `Intelligence Update: ${data.countryName}\n\n` +
        ...
        `\nData via World Monitor by Dexmond Technologies`,
    telegram: (data) => `${countryFlag(data.countryCode)} *${data.countryName} Intelligence*\n\n` +
        `📊 Instability: *${data.cii?.score || 'N/A'}/100* (${data.cii?.level || 'N/A'})\n` +
        `📈 Trend: *${data.cii?.trend || 'stable'}*\n` +
...
function getShareUrls(data) {
    ...
    const text = encodeURIComponent(exports.shareTexts.twitter(data));
    return {
        ...
        whatsapp: `https://wa.me/?text=${encodeURIComponent(exports.shareTexts.whatsapp(data).replace('\n', '%0A'))}`,
        telegram: `https://t.me/share/url?url=${encodeURIComponent(url)}&text=${encodeURIComponent(exports.shareTexts.telegram(data).replace('\n', '%0A'))}`,
    };
}
