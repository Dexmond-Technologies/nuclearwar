...
exports.fetchProtestEvents = fetchProtestEvents;
exports.getProtestStatus = getProtestStatus;
const service_client_1 = require("@/generated/client/worldmonitor/unrest/v1/service_client");
const utils_1 = require("@/utils");
// ---- Client + Circuit Breaker ----
const client = new service_client_1.UnrestServiceClient('', { fetch: (...args) => globalThis.fetch(...args) });
const unrestBreaker = (0, utils_1.createCircuitBreaker)({
    name: 'Unrest Events',
...
function toSocialUnrestEvent(e) {
    return {
        id: e.id,
        title: e.title,
...
async function fetchProtestEvents() {
