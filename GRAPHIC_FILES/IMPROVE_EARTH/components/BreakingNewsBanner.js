...
exports.BreakingNewsBanner = void 0;
...
class BreakingNewsBanner {
    constructor() {
        ...
        this.observedPostureBanner = null;
    ...
    createAlertElement(alert) {
        ...
        const levelText = alert.threatLevel === 'critical'
            ? (0, i18n_1.t)('components.breakingNews.critical')
            : (0, i18n_1.t)('components.breakingNews.high');
        ...
        dismissBtn.title = (0, i18n_1.t)('components.breakingNews.dismiss');
...
exports.BreakingNewsBanner = BreakingNewsBanner;
