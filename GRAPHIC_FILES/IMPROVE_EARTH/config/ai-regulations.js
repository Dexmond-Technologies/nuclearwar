...
exports.COUNTRY_REGULATION_PROFILES = exports.REGULATORY_ACTIONS = exports.AI_REGULATIONS = void 0;
exports.getRegulationById = getRegulationById;
exports.getCountryProfile = getCountryProfile;
exports.getRegulationsByCountry = getRegulationsByCountry;
...
exports.COUNTRY_REGULATION_PROFILES = [
    {
        country: 'United States',
        countryCode: 'US',
        stance: 'moderate',
...
function getRegulationById(id) {
    return exports.AI_REGULATIONS.find(reg => reg.id === id);
}
// Helper function to get country profile
function getCountryProfile(countryCode) {
    return exports.COUNTRY_REGULATION_PROFILES.find(profile => profile.countryCode === countryCode);
}
// Helper function to get regulations by country
function getRegulationsByCountry(country) {
    return exports.AI_REGULATIONS.filter(reg => reg.country === country);
}
...
function getRecentActions(months = 6) {
    const cutoffDate = new Date();
    cutoffDate.setMonth(cutoffDate.getMonth() - months);
    return exports.REGULATORY_ACTIONS
