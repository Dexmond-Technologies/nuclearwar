...
exports.PIPELINE_STATUS_COLORS = exports.PIPELINE_COLORS = exports.PIPELINES = void 0;
exports.getPipelineStatusColor = getPipelineStatusColor;
...
function getPipelineStatusColor(status) {
    switch (status) {
        case 'operating': return (0, utils_1.getCSSColor)('--status-live');
        case 'construction': return (0, utils_1.getCSSColor)('--semantic-elevated');
...
exports.PIPELINE_STATUS_COLORS = {
    operating: '#44ff88',
    construction: '#ffaa00',
};
