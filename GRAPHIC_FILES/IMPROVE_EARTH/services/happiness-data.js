...
exports.fetchHappinessScores = fetchHappinessScores;
/**
 ...
 */
async function fetchHappinessScores() {
    const { default: raw } = await Promise.resolve().then(() => __importStar(require('@/data/world-happiness.json')));
    return {
        year: raw.year,
        source: raw.source,
