...
exports.getSnapshotAt = getSnapshotAt;
exports.cleanOldSnapshots = cleanOldSnapshots;
exports.getSnapshotTimestamps = getSnapshotTimestamps;
...
async function updateBaseline(key, currentCount) {
    const now = Date.now();
...
async function getSnapshots(fromTime, toTime) {
...
async function getSnapshotAt(timestamp) {
...
async function getSnapshotTimestamps() {
