...
exports.TELEGRAM_TOPICS = void 0;
exports.fetchTelegramFeed = fetchTelegramFeed;
exports.formatTelegramTime = formatTelegramTime;
const utils_1 = require("@/utils");
const runtime_1 = require("@/services/runtime");
exports.TELEGRAM_TOPICS = [
...
function telegramFeedUrl(limit) {
    ...
    return (0, runtime_1.isDesktopRuntime)() ? (0, utils_1.proxyUrl)(path) : path;
}
async function fetchTelegramFeed(limit = 50) {
...
function formatTelegramTime(ts) {
