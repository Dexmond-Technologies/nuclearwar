...
exports.LiveWebcamsPanel = void 0;
...
class LiveWebcamsPanel extends Panel_1.Panel {
    constructor() {
        super({ id: 'live-webcams', title: (0, i18n_1.t)('panels.liveWebcams'), className: 'panel-wide' });
        this.viewMode = 'grid';
        this.regionFilter = 'iran';
        this.activeFeed = WEBCAM_FEEDS[0];
        this.toolbar = null;
        this.iframes = [];
        this.observer = null;
        this.isVisible = false;
        this.idleTimeout = null;
        this.IDLE_PAUSE_MS = 5 * 60 * 1000;
        this.isIdle = false;
        this.createToolbar();
        this.setupIntersectionObserver();
        this.setupIdleDetection();
        (0, ai_flow_settings_1.subscribeStreamQualityChange)(() => this.render());
        this.render();
    }
    get filteredFeeds() {
    ...
    createToolbar() {
        ...
        const regions = [
            { key: 'iran', label: (0, i18n_1.t)('components.webcams.regions.iran') },
            { key: 'all', label: (0, i18n_1.t)('components.webcams.regions.all') },
            { key: 'middle-east', label: (0, i18n_1.t)('components.webcams.regions.mideast') },
            { key: 'europe', label: (0, i18n_1.t)('components.webcams.regions.europe') },
            { key: 'americas', label: (0, i18n_1.t)('components.webcams.regions.americas') },
            { key: 'asia', label: (0, i18n_1.t)('components.webcams.regions.asia') },
        ];
    ...
    setRegionFilter(filter) {
        if (filter === this.regionFilter)
            return;
        (0, analytics_1.trackWebcamRegionFiltered)(filter);
    ...
    buildEmbedUrl(videoId) {
        ...
        if ((0, runtime_1.isDesktopRuntime)()) {
            ...
            return `http://localhost:${(0, runtime_1.getLocalApiPort)()}/api/youtube-embed?${params.toString()}`;
        }
    ...
    renderGrid() {
        ...
        feeds.forEach((feed, i) => {
            ...
            label.innerHTML = `<span class="webcam-live-dot"></span><span class="webcam-city">${(0, sanitize_1.escapeHtml)(feed.city.toUpperCase())}</span>`;
            if (desktop) {
                ...
                expandBtn.title = (0, i18n_1.t)('webcams.expand') || 'Expand';
                ...
                expandBtn.addEventListener('click', (e) => {
                    e.stopPropagation();
                    (0, analytics_1.trackWebcamSelected)(feed.id, feed.city, 'grid');
    ...
    renderSingle() {
        ...
        this.filteredFeeds.forEach(feed => {
            ...
            btn.addEventListener('click', () => {
                (0, analytics_1.trackWebcamSelected)(feed.id, feed.city, 'single');
                this.activeFeed = feed;
                this.render();
            });
...
exports.LiveWebcamsPanel = LiveWebcamsPanel;
LiveWebcamsPanel.ALL_GRID_IDS = ['jerusalem', 'tehran', 'kyiv', 'washington'];
