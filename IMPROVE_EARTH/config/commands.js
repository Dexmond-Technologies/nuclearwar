...
exports.COMMANDS = exports.LAYER_KEY_MAP = exports.LAYER_PRESETS = void 0;
const countries_1 = require("@/config/countries");
exports.LAYER_PRESETS = {
...
const COUNTRY_COMMANDS = ISO_CODES.map(code => {
    const curated = countries_1.CURATED_COUNTRIES[code];
...
exports.COMMANDS.push(...COUNTRY_COMMANDS);
