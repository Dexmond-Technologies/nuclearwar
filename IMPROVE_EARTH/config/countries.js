...
exports.HOTSPOT_COUNTRY_MAP = exports.DEFAULT_EVENT_MULTIPLIER = exports.DEFAULT_BASELINE_RISK = exports.TIER1_COUNTRIES = exports.CURATED_COUNTRIES = void 0;
exports.getHotspotCountries = getHotspotCountries;
exports.CURATED_COUNTRIES = {
    US: {
        name: 'United States',
...
exports.DEFAULT_BASELINE_RISK = 15;
exports.DEFAULT_EVENT_MULTIPLIER = 1.0;
exports.HOTSPOT_COUNTRY_MAP = {
...
function getHotspotCountries(hotspotId) {
    const val = exports.HOTSPOT_COUNTRY_MAP[hotspotId];
    if (!val)
        return [];
