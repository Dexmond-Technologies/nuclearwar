...
exports.fetchCachedTheaterPosture = fetchCachedTheaterPosture;
exports.getCachedPosture = getCachedPosture;
exports.hasCachedPosture = hasCachedPosture;
...
function toPostureSummary(proto) {
...
async function fetchCachedTheaterPosture(signal) {
    if (signal?.aborted)
...
function getCachedPosture() {
    return cachedPosture;
}
function hasCachedPosture() {
