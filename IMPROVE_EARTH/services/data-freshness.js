...
exports.dataFreshness = void 0;
exports.getStatusColor = getStatusColor;
exports.getStatusIcon = getStatusIcon;
exports.getIntelligenceGaps = getIntelligenceGaps;
exports.getIntelligenceGapSummary = getIntelligenceGapSummary;
exports.hasCriticalGaps = hasCriticalGaps;
...
// Singleton instance
exports.dataFreshness = new DataFreshnessTracker();
// Helper to get status color
function getStatusColor(status) {
    switch (status) {
        case 'fresh': return (0, utils_1.getCSSColor)('--semantic-normal');
        case 'stale': return (0, utils_1.getCSSColor)('--semantic-elevated');
        case 'very_stale': return (0, utils_1.getCSSColor)('--semantic-high');
        case 'error': return (0, utils_1.getCSSColor)('--semantic-critical');
        case 'disabled': return (0, utils_1.getCSSColor)('--text-muted');
        case 'no_data': return (0, utils_1.getCSSColor)('--text-dim');
    }
}
...
const INTELLIGENCE_GAP_MESSAGES = {
 ...
 */
function getIntelligenceGaps() {
    const gaps = [];
    for (const source of exports.dataFreshness.getAllSources()) {
 ...
 */
function getIntelligenceGapSummary() {
