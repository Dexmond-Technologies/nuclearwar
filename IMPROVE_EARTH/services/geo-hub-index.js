...
exports.inferGeoHubsFromTitle = inferGeoHubsFromTitle;
exports.getGeoHubById = getGeoHubById;
exports.getAllGeoHubs = getAllGeoHubs;
...
function inferGeoHubsFromTitle(title) {
...
function getGeoHubById(hubId) {
    const index = buildGeoHubIndex();
    return index.hubs.get(hubId);
}
function getAllGeoHubs() {
    const index = buildGeoHubIndex();
