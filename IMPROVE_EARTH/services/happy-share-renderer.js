...
exports.renderHappyShareCard = renderHappyShareCard;
exports.shareHappyCard = shareHappyCard;
...
const DEFAULT_CATEGORY = 'humanity-kindness';
/**
 ...
 */
async function renderHappyShareCard(item) {
    ...
    const category = item.happyCategory || DEFAULT_CATEGORY;
    ...
    const categoryLabel = positive_classifier_1.HAPPY_CATEGORY_LABELS[category];
 ...
 */
async function shareHappyCard(item) {
