...
exports.fetchPizzIntStatus = fetchPizzIntStatus;
exports.fetchGdeltTensions = fetchGdeltTensions;
exports.getPizzIntStatus = getPizzIntStatus;
exports.getGdeltStatus = getGdeltStatus;
...
// ---- Circuit breakers ----
const pizzintBreaker = (0, utils_1.createCircuitBreaker)({
    name: 'PizzINT',
    maxFailures: 3,
...
const gdeltBreaker = (0, utils_1.createCircuitBreaker)({
    name: 'GDELT Tensions',
    maxFailures: 3,
    cooldownMs: 5 * 60 * 1000,
...
function toStatus(proto) {
    ...
    return {
        defconLevel: level,
        defconLabel: (0, i18n_1.t)(DEFCON_LABELS[level] ?? DEFCON_LABELS[5]),
...
const defaultStatus = {
    defconLevel: 5,
    defconLabel: (0, i18n_1.t)('components.pizzint.defconLabels.5'),
    aggregateActivity: 0,
    activeSpikes: 0,
...
function getPizzIntStatus() {
    return pizzintBreaker.getStatus();
}
function getGdeltStatus() {
