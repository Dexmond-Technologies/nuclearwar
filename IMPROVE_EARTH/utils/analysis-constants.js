...
exports.SIGNAL_CONTEXT = exports.TOPIC_MAPPINGS = exports.SUPPRESSED_TRENDING_TERMS = exports.TOPIC_KEYWORDS = exports.FLOW_DROP_KEYWORDS = exports.PIPELINE_KEYWORDS = exports.ENERGY_COMMODITY_SYMBOLS = exports.FLOW_PRICE_THRESHOLD = exports.NEWS_VELOCITY_THRESHOLD = exports.MARKET_MOVE_THRESHOLD = exports.PREDICTION_SHIFT_THRESHOLD = exports.STOP_WORDS = exports.SIMILARITY_THRESHOLD = void 0;
exports.tokenize = tokenize;
exports.jaccardSimilarity = jaccardSimilarity;
exports.includesKeyword = includesKeyword;
exports.escapeRegex = escapeRegex;
exports.containsTopicKeyword = containsTopicKeyword;
exports.findRelatedTopics = findRelatedTopics;
exports.generateSignalId = generateSignalId;
exports.generateDedupeKey = generateDedupeKey;
exports.getSignalContext = getSignalContext;
// Clustering constants
exports.SIMILARITY_THRESHOLD = 0.5;
...
exports.PREDICTION_SHIFT_THRESHOLD = 5;
exports.MARKET_MOVE_THRESHOLD = 2;
exports.NEWS_VELOCITY_THRESHOLD = 3;
exports.FLOW_PRICE_THRESHOLD = 1.5;
exports.ENERGY_COMMODITY_SYMBOLS = new Set(['CL=F', 'NG=F']);
exports.PIPELINE_KEYWORDS = ['pipeline', 'pipelines', 'line', 'terminal'];
exports.FLOW_DROP_KEYWORDS = [
...
exports.SUPPRESSED_TRENDING_TERMS = new Set([
    // Meta / media terms
...
function findRelatedTopics(prediction) {
    const title = prediction.toLowerCase();
    const related = [];
    for (const [key, topics] of Object.entries(exports.TOPIC_MAPPINGS)) {
...
function generateDedupeKey(type, identifier, value) {
...
function getSignalContext(type) {
    const key = exports.SIGNAL_CONTEXT[type] ? type : 'fallback';
    return {
        whyItMatters: (0, i18n_1.t)(`signals.context.${key}.whyItMatters`),
        actionableInsight: (0, i18n_1.t)(`signals.context.${key}.actionableInsight`),
        confidenceNote: (0, i18n_1.t)(`signals.context.${key}.confidenceNote`),
    };
}
